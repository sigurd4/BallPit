...
public class Ears : Behavioural
{
    ...
    {
        Vector3 earPos = this.ball.transform.right*this.ball.GetRadius();
        ...
        foreach(Ball other in balls)
        {
            ...
            Vector3 r = other.transform.position + other.transform.forward*other.GetRadius() - this.ball.transform.position;
